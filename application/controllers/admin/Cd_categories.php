...
class Cd_categories extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('admin/cd_categories', $data);
	...
	public function add()
	{
		if (!empty($this->input->post())) 
		{
			...
			{
				$this->load->view('admin/header');
				$this->load->view('admin/cd_category_add');
				$this->load->view('admin/footer');
			}
			else
			{
	...
	public function edit($id)
	{
		if (!empty($this->input->post())) 
		{
			...
			if ($this->form_validation->run() == FALSE) 
			{
				...
				$this->load->view('admin/header');
				$this->load->view('admin/cd_category_edit', $data);
				$this->load->view('admin/footer');
			}
			else
			{
...
INNER JOIN tbl_categories c ON c.id=tbl_sub_heading.cat_id");
		...
		$this->load->view('admin/header');
		$this->load->view('admin/cd_sub_heading',$data);
		$this->load->view('admin/footer');
	}
	...
	public function sub_add()
	{
		if (!empty($this->input->post())) 
		{
			...
			if ($this->form_validation->run() == FALSE) 
			{
				...
				$this->load->view('admin/header');
				$this->load->view('admin/cd_sub_heading_add',$data);
				$this->load->view('admin/footer');
			}
			else
			{
				...
				redirect('admin/cd_categories/sub_list');
			}
		} 
		else 
		{
	...
	public function sub_edit($id)
	{
		if (!empty($this->input->post())) 
		{
			...
			if ($this->form_validation->run() == FALSE) 
			{
				...
				$this->load->view('admin/header');
				$this->load->view('admin/cd_sub_heading_edit',$data);
				$this->load->view('admin/footer');
			}
			else
			{
