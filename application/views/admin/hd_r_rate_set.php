		...
		<div class="col-lg-12">
			...
			<div class="block">
				...
				<?php 
					...
					echo form_open('admin/hd_r_rate/revise/'.$ad_price->id, $attributes)
					?>
					<?php
				...
				<div class="col-lg-6">
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" value="<?php echo $s_newspaper;?>" class="form-control" name="newspaper" id="newspaper" readonly >
						</div>
					</div>
					<div class="form-group">
						<label for="price" class="col-md-3 control-label">Ad Heading</label>
						<div class="col-md-9">
							<input type="text" value="<?php echo $cat_name->position;?>" class="form-control" name="ad_cat" id="ad_cat" readonly >
						</div>
					</div>					
					<div class="form-group">
						<label for="price" class="col-md-3 control-label">Insertion From</label>
						<div class="col-md-9">
							<input type="number"  onkeyup="inse_to();"  onchange="inse_to();" placeholder=""  value="<?php echo $ad_price->ins_from?>" class="form-control" name="ins_from" id="ins_from" readonly >
						</div>
					</div>
					<div class="form-group">
						<label for="price" class="col-md-3 control-label">Insertion To</label>
						<div class="col-md-9">
							<input type="number" placeholder="" class="form-control" name="ins_to" id="ins_to" value="<?php echo $ad_price->ins_to?>" readonly >
						</div>
					</div>
					<div class="form-group">
				...
				<div class="col-lg-6">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" placeholder="" value="<?php echo $ad_price->b_rate?>" class="form-control" name="bprice" id="bprice" required>
						</div>
					</div>
					<div class="form-group">
						<label for="price" class="col-md-3 control-label">Fix Price</label>
						<div class="col-md-9">
							<input type="text" placeholder="" value="<?php echo $ad_price->f_rate?>" class="form-control" name="fprice" id="fprice" required>
						</div>
					</div>
					<!--<div class="form-group">
...
function get_city1()
{
	...
	var newspaper = $("#newspaper").val();
	$.ajax({                
			url: "<?php echo base_url(); ?>" + "admin/hd_price/get_city",
			type: "POST",				
			async: true ,               
