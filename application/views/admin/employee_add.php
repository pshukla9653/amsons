				...
				<?php 
					...
					?>
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" placeholder="Enter Employee Name"  required="required" class="form-control" name="name" id="name">
							</div>
							</div>
							<div class="form-group">
							<label for="name" class="col-md-3 control-label">E-mail</label>
								<div class="col-md-9">
									<input type="email" placeholder="Enter E-mail" class="form-control" name="email" id="email">
								</div>
							</div>
							<div class="form-group">
							...
							<label for="name" class="col-md-3 control-label">State</label>
								<div class="col-md-9">
									<input type="text" placeholder="Enter State" class="form-control" name="state" id="state">
								</div>
							</div>
							<div class="form-group">
							<label for="name" class="col-md-3 control-label">Pin Code</label>
								<div class="col-md-9">
									<input type="text" placeholder="Enter Postal Code" class="form-control" name="pin" id="pin">
								</div>
							</div>
							<div class="form-group">
							<label for="name" class="col-md-3 control-label">Mobile</label>
								<div class="col-md-9">
									<input type="text" placeholder="Enter Mobile" class="form-control" name="mobile" id="mobile">
								</div>
							</div>
							<div class="form-group">
							<label for="name" class="col-md-3 control-label">Credit Limit</label>
								<div class="col-md-9">
									<input type="text" placeholder="Enter Credit Limit" class="form-control" name="crlimit" id="crlimit">
								</div>
							</div>
							<div class="form-group">
