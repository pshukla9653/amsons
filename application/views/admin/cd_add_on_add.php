			...
			<div class="block">
				...
				<div class="block-title">
					<h2>
						...
						<strong>Classified Display Add On</strong>
				...
				<?php 
					...
					echo form_open_multipart('admin/cd_add_on/add', $attributes); ?>
					<?php
				...
				<div class="col-lg-6">
					...
					<div class="form-group">
                     ...
                     <div id="single_c">
                        <div class="form-group">
                            <label for="price" class="col-md-3 control-label">Add on Size</label>
                            <div class="col-md-1 control-label">
                                MIN
                            </div>
                            <div class="col-md-2">
                                <input type="text" placeholder="" class="form-control" name="f_unit" id="f_unit" min="1" required>
                            </div>
                            <div class="col-md-1 control-label">
                                X
                            </div>
                            ...
                            <div class="col-md-2">
                                <input type="text" placeholder="" class="form-control" name="t_unit" id="t_unit" >
                            </div>
                        </div>	
					...
					<div class="form-group">
						<div class="col-md-9 col-md-offset-3">
							...
							<a href="<?php echo base_url()?>admin/cd_add_on"><div class="btn btn-sm btn-primary">
...
function save()
{
	...
	var form_data= {'newspaper_group':newspaper_group,'m_newspaper':m_newspaper,'a_newspaper':a_newspaper,'ad_cat':ad_cat,'ins_from':ins_from,'ins_to':ins_to,'unit':unit,'date_f':date_from,'date_t':date_to,'f_unit':f_unit,'t_unit':t_unit,'price':price,'eprice':eprice,'mul':mul,'days':days};
	
	$.ajax({
			url: "<?php echo base_url(); ?>" + "admin/cd_add_on/save",
			type: "POST",				
			async: true ,               
			data: form_data,
