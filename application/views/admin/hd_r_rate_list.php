			...
			<div class="row">
				<div class="col-sm-6 col-xs-7">
					...
					<?php 
						...
						echo form_open('admin/hd_r_rate/', $attributes);
					?>
						...
						<tr role="row" class="odd">
							...
							<td class="text-center">
								...
								<div class="btn-group btn-group-xs">
									<a class="btn btn-primary" title="" data-toggle="tooltip" href="<?php echo base_url(); ?>admin/hd_r_rate/revise/<?php echo $ad_price->id ;?>" data-original-title="Revise Rate">
