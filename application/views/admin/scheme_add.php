		...
		<div class="col-lg-12">
			...
			<div class="block">
				...
				<?php 
					...
					echo form_open_multipart('admin/scheme/add', $attributes); ?>
					<?php
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" placeholder="" class="form-control" name="scheme" id="scheme" required>
						</div>
					</div>
					<div class="form-group">
						<label for="pack-price" class="col-md-3 control-label">Paid Day</label>
						<div class="col-md-9">
							<input type="text" placeholder="" class="form-control" name="paid" id="paid" required>
						</div>
					</div>
					<div class="form-group">
						<label for="pack-price" class="col-md-3 control-label">Free Day</label>
						<div class="col-md-9">
							<input type="text" placeholder="" class="form-control" name="free" id="free" required>
						</div>
					</div>
