<div id="page-content" style="min-height: 1189px;">
	...
	<div class="row text-center">
		<div class="col-sm-6 col-lg-3">
			<a class="widget widget-hover-effect2" href="<?php echo base_url();?>admin/postpone_letter/add">
				<div class="widget-extra themed-background-success">
					<h4 class="widget-content-light">
						<strong>Genrate</strong>Postpone Letter
					</h4>
				</div>
	...
	<div class="block full">
		...
		<div class="block-title">
			...
			<h2>
				<strong>All </strong>Postpone Letters<br>
				<?php
				...
				<table class="table table-bordered table-striped table-vcenter dataTable no-footer" id="ecom-products" role="grid" aria-describedby="ecom-products_info">
					<thead>
						<tr role="row">
							...
							<th class="text-center">Postpone DOP</th>
					...
					<tbody>
						...
						<tr role="row" class="odd">
							...
							<td>
								<?php echo $letter->ro_id ;?>
							</td>
							<td class="text-center">
								<?php echo $letter->client_id ;?>
							</td>							
							<td class="text-center">
							...
							<td class="text-center">
								<div class="btn-group btn-group-xs">
									<a class="btn btn-default" title="" data-toggle="tooltip" href="<?php echo base_url(); ?>admin/postpone_letter/edit/<?php echo $letter->id ;?>" data-original-title="Edit">
										<i class="fa fa-pencil"></i>
									</a>
									<a class="btn btn-xs btn-danger" title="" data-toggle="tooltip"  onclick="return confirm('Are you sure you want to delete this letter?');" href="<?php echo base_url(); ?>admin/postpone_letter/del/<?php echo $letter->id ;?>" data-original-title="Delete">
