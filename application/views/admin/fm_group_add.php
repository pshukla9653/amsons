			...
			<div class="block">
				...
				<div class="block-title">
					<h2>
						...
						<strong>Add New</strong> FM Group
					</h2>
				</div>
				...
				<?php 
					...
					echo form_open_multipart('admin/fm/group_add', $attributes); ?>
					<?php
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" placeholder="Enter Fm Group Name.." required="required" class="form-control" name="name" id="name" value="<?php echo set_value('name'); ?>">
						</div>
					</div>
					<div class="form-group">
...
function get_city(c,i){
	console.log(c+"/"+i+"<br>");
	$.ajax({
		url: "<?php echo base_url(); ?>" + "admin/fm/get_city",
		type: "POST",
		async: true ,
		data: {state:i},
