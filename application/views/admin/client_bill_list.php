<div id="page-content" style="min-height: 1189px;">
	...
	<div class="row text-center">
		<div class="col-sm-6 col-lg-3">
			<a class="widget widget-hover-effect2" href="<?php echo base_url();?>admin/client_bill/add">
				<div class="widget-extra themed-background-success">
					<h4 class="widget-content-light">
						<strong>Add </strong> Client Bill
					</h4>
				</div>
				...
				<table class="table table-bordered table-striped table-vcenter dataTable no-footer" id="ecom-products" role="grid" aria-describedby="ecom-products_info">
					...
					<tbody>
						...
						<tr role="row" class="odd">
							...
							<td>
								<?php echo $bill->client_name ;?>
							</td>
							<td class="text-center">
								<?php if($bill->Shared_Status=='Cancel'){echo '0';}else{echo $bill->net_amount ;}?>
							</td>
							<td class="text-center">
								<?php if($bill->Shared_Status=='Cancel'){echo '0';}else{echo $bill->bill_date ;}?>
							</td>
							<td class="text-center">
								<?php if($bill->Shared_Status=='Cancel'){echo '0';}else{echo $bill->due_date ;}?>
							</td>							
							<td class="text-center"><?php if($bill->Shared_Status=='Cancel'){echo 'CANCELED';}else{?>
								<div class="btn-group btn-group-xs">
									<a class="btn btn-default" title="" data-toggle="tooltip" href="<?php echo base_url(); ?>admin/client_bill/bill_print/<?php echo $bill->id ;?>" data-original-title="Print">
										<i class="fa fa-print"></i>
									</a>
									<a class="btn btn-default" title="" data-toggle="tooltip" href="<?php echo base_url(); ?>admin/client_bill/edit/<?php echo $bill->id ;?>" data-original-title="Edit">
										<i class="fa fa-pencil"></i>
									</a>
									<a class="btn btn-xs btn-danger" title="" data-toggle="tooltip"  onclick="return confirm('Are you sure you want to delete this Bill?');" href="<?php echo base_url(); ?>admin/client_bill/del_bill/<?php echo $bill->id ;?>" data-original-title="Delete">
