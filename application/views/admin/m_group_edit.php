			...
			<div class="block">
				...
				<div class="block-title">
					<h2>
						...
						<strong>Edit </strong> Magazine Group
					</h2>
				</div>
				...
				<?php 
					...
					echo form_open_multipart('admin/magazine/group_edit/'.$newspaper_group->ng_id , $attributes); ?>
					<?php
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" placeholder="Enter Magazine Group Name.." required="required" class="form-control" name="name" id="name" value="<?php echo $newspaper_group->ng_name?>">
						</div>
					</div>
					<div class="form-group">
