<div id="page-content" style="min-height: 1189px;">
	...
	<div class="row text-center">
		<div class="col-sm-6 col-lg-3">
			<a class="widget widget-hover-effect2" href="<?php echo base_url();?>admin/ins_letter/add">
				<div class="widget-extra themed-background-success">
					<h4 class="widget-content-light">
						<strong>Add</strong> New Letter
					</h4>
				</div>
	...
	<div class="block full">
		...
		<div class="block-title">
			...
			<h2>
				<strong>All </strong>Insertion Letter<br>
				<?php
		...
		<div id="ecom-products_wrapper" class="dataTables_wrapper form-inline no-footer">
				...
				<table class="table table-bordered table-striped table-vcenter dataTable no-footer" id="ecom-products" role="grid" aria-describedby="ecom-products_info">
					<thead>
						<tr role="row">
							...
							<th class="text-center">Last DOP</th>
					...
					<tbody>
						...
						<tr role="row" class="odd">
							<td class="text-center">
									<strong><?php echo $letter->letter_no ;?></strong>
							</td>
							<td>
							...
							<td class="text-center">
								<?php echo date('d-m-Y',strtotime($letter->ro_date)) ;?>
							</td>
							<td class="text-center">
								<?php echo date('d-m-Y',strtotime($letter->ro_date)) ;?>
							</td>
							<td class="text-center">
								<?php echo date('d-m-Y',strtotime($letter->c_date)) ;?>
							</td>							
							<td class="text-center">
								<div class="btn-group btn-group-xs">
									<a class="btn btn-default" title="" data-toggle="tooltip" href="<?php echo base_url(); ?>admin/ins_letter/letter_print/<?php echo $letter->id ;?>" data-original-title="Print">
										<i class="fa fa-print"></i>
									</a>
									<a class="btn btn-default" title="" data-toggle="tooltip" href="<?php echo base_url(); ?>admin/ins_letter/edit/<?php echo $letter->id ;?>" data-original-title="Edit">
										<i class="fa fa-pencil"></i>
									</a>
									<a class="btn btn-xs btn-danger" title="" data-toggle="tooltip"  onclick="return confirm('Are you sure you want to delete this letter?');" href="<?php echo base_url(); ?>admin/ins_letter/del/<?php echo $letter->id ;?>" data-original-title="Delete">
			...
			<?php }  
						/* <div class="dataTables_info" id="ecom-products_info" role="status" aria-live="polite">
							<strong><?php echo (($curr_page *$per_page)+1) ; ?></strong> -
							<strong><?php echo ($curr_page==0)?$total_rows:$curr_page*$per_page ;?></strong> of 
