<div id="page-content" style="min-height: 1189px;">
	...
	<div class="row text-center">
		<div class="col-sm-6 col-lg-3">
			<a class="widget widget-hover-effect2" href="<?php echo base_url();?>admin/hd_package/add">
				<div class="widget-extra themed-background-success">
					<h4 class="widget-content-light">
						<strong>Add New </strong>HD Package
					</h4>
				</div>
						...
						<tr role="row" class="odd">
							...
							<td class="text-center">
								<div class="btn-group btn-group-xs">
									<a class="btn btn-default" title="" data-toggle="tooltip" href="<?php echo base_url(); ?>admin/hd_package/edit/<?php echo $pack->id ; ?>" data-original-title="Edit">
										<i class="fa fa-pencil"></i>
									</a>
									<a class="btn btn-xs btn-danger" title="" data-toggle="tooltip" onclick="return confirm('Are you sure you want to delete this package?');" href="<?php echo base_url(); ?>admin/hd_package/del/<?php echo $pack->id ;?>" data-original-title="Delete">
