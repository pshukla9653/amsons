<div id="page-content" style="min-height: 1189px;">
	...
	<div class="row text-center">
		<div class="col-sm-6 col-lg-3">
			<a class="widget widget-hover-effect2" href="<?php echo base_url();?>admin/employee/add">
				...
				<table class="table table-bordered table-striped table-vcenter dataTable no-footer" id="ecom-products" role="grid" aria-describedby="ecom-products_info">
					<thead>
						<tr role="row">
							...
							<th class="text-center" style="width: 209px;">Employee Name</th>
							<th>Credit Limit</th>
							<th>Address</th>
							<th>Mobile</th>
							<th>Jion Date</th>
					...
					<tbody>
						...
						<tr role="row" class="odd">
							<td class="text-center">
									<strong><?php echo $employee->e_id ;?></strong>
							</td>
							<td class="text-center">
								<?php echo $employee->e_name ;?>
							</td>
							<td>
								<?php echo $employee->e_cr_limit ;?>
							</td>
							<td>
								<?php echo $employee->e_address1 ;?>
							</td>
							<td>
								<?php echo $employee->e_phone;?>
							</td>
							<td class="text-center">
								<?php echo date('d-m-Y',strtotime($employee->e_join_date));?>
							</td>
							<td class="text-center">
								<?php echo date('d-m-Y',strtotime($employee->e_last_date));?>
							</td>
							<td class="text-center">
								<div class="btn-group btn-group-xs">
									<a class="btn btn-default" title="" data-toggle="tooltip" href="<?php echo base_url(); ?>admin/employee/edit/<?php echo $employee->e_id ; ?>" data-original-title="Edit">
										<i class="fa fa-pencil"></i>
									</a>
									<a class="btn btn-xs btn-danger" title="" data-toggle="tooltip" onclick="return confirm('Are you sure you want to delete this Employee?');" href="<?php echo base_url(); ?>admin/employee/del/<?php echo $employee->e_id ;?>" data-original-title="Delete">
