		...
		<div class="col-lg-12">
			...
			<div class="block">
				...
				<?php 
					...
					echo form_open_multipart('admin/fm/add', $attributes); ?>
					<?php
					...
					<div class="form-group">
                        ...
                        <div class="col-md-9">
							<select id="g_id" name="g_id" class="select-chosen" data-placeholder="Choose Group" style="width: 250px;" required>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" placeholder="Enter FM Channel Name.." required="required" class="form-control" name="name" id="name">
						</div>
					</div>
					<div class="form-group">
						<label for="name" class="col-md-3 control-label">Short Name</label>
						<div class="col-md-9">
							<input type="text" placeholder="Enter FM Channel Short Name.." required="required" class="form-control" name="sname" id="sname">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="col-md-3 control-label" for="example-chosen-multiple">Language </label>
                        <div class="col-md-9">
...
<option value="Xhosa">Xhosa</option>
					...
					<div class="form-group">
						<label for="example-file-input" class="col-md-3 control-label">FM Channel Logo</label>
						<div class="col-md-9">
