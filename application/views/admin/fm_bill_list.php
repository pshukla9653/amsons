<div id="page-content" style="min-height: 1189px;">
	...
	<div class="row text-center">
		<div class="col-sm-6 col-lg-3">
			<a class="widget widget-hover-effect2" href="<?php echo base_url();?>admin/fm_bill/add">
				<div class="widget-extra themed-background-success">
					<h4 class="widget-content-light">
						<strong>Add </strong> FM Bill
					</h4>
				</div>
	...
	<div class="block full">
		...
		<div class="block-title">
			...
			<h2>
				<strong>All</strong>FM Bill list<br>
				<?php
			...
			<div class="row">
				<div class="col-sm-6 col-xs-7">
					...
					<?php 
						...
						echo form_open('admin/fm_bill/', $attributes);
					?>
						...
						<tr role="row" class="odd">
							...
							<td class="text-center">
								<div class="btn-group btn-group-xs">
									<a class="btn btn-default" title="" data-toggle="tooltip" href="<?php echo base_url(); ?>admin/fm_bill/bill_print/<?php echo $bill->id ;?>" data-original-title="Print">
										<i class="fa fa-print"></i>
									</a>
									<a class="btn btn-default" title="" data-toggle="tooltip" href="<?php echo base_url(); ?>admin/fm_bill/edit/<?php echo $bill->bill_no ;?>" data-original-title="Edit">
										<i class="fa fa-pencil"></i>
									</a>
									<a class="btn btn-xs btn-danger" title="" data-toggle="tooltip"  onclick="return confirm('Are you sure you want to delete this Bill?');" href="<?php echo base_url(); ?>admin/fm_bill/del/<?php echo $bill->bill_no ;?>" data-original-title="Delete">
