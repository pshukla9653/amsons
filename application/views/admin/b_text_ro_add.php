<div id="page-content" style="min-height: 1189px;">
	...
	<?php 
					...
					echo form_open_multipart('admin/booking_text_ro/add', $attributes); ?>
					<?php
		...
		<div class="col-lg-6">
			...
			<div class="block">
				...
				<!-- General Data Content -->									
					...
					<div class="form-group">
					     <label class="col-md-2 control-label" for="example-chosen-multiple">Select State <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4">
                            ...
                            <label class="col-md-2 control-label" for="example-chosen-multiple">Booking No. <span class="text-danger">*</span></label>
                        ...
                        <input type="text" id="book_id" name="book_id" value="<?php echo $bd; ?>" >
					...
					<div class="form-group">
                        ...
                        <div class="col-md-9">
							<select id="cat" name="cat" class="form-control" onblur="get_sub_heading();" data-placeholder="Choose heading" required>
								<option value="">Choose One</option>
                            </select>
                        </div>
                    </div>					
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" pattern=".*\d"  onblur="date_pic1();" min="1" placeholder="" class="form-control" name="inse" id="inse" required>
						</div>
					</div>
					<!--
					<div class="form-group">
					...
					<div id="pack_paper" style="display: none;">
						<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<div class="box"  id="from--input">
									   <input class="form-control mydata" name="p_date" autocomplete="off" onkeydown="#dopModal" onblur="get_dop_price(); " type="text" id="from-input" data-id="" data-toggle="modal" data-target="#dopModal" placeholder="mm/dd/yyyy, ...">
									</div>
			...
			<div class="block">
				...
				<!-- General Data Content -->
					<div class="form-group">
                        ...
                        <div class="col-md-9">
							<select id="client" name="client" style="width:100%" class="js-example-basic-single" onchange="get_client();"  data-placeholder="Choose Classes" required>
					...
					<label for="example-textarea-input" class="col-md-3 control-label">Matter <span class="text-danger">*</span></label>
						<div class="col-md-9">
						<textarea placeholder="Ad Matter.." onkeyup="wordcount(this.value)"  onchange="amount_calculate();" class="form-control" rows="8" name="matter" id="matter" minlength="16"></textarea>
						<div id="w_count"></div>
...
else
{
	...
	ele1.value = cnt;
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" placeholder="" class="form-control" name="w_count1" id="w_count1" onchange="amount_calculate();" onselect="amount_calculate();">
							<!--
					...
					<div class="form-group">
						<label class="col-md-3 control-label" for="example-chosen-multiple">Employee <span class="text-danger">*</span></label>
                        <div class="col-md-9">
							<select id="employee" name="employee" class="form-control" data-placeholder="Choose one"  required>
										<option value="" >Select Employee</option>
								<?php foreach($employees as $employee){ ?>
                                        <option value="<?php echo $employee->e_id; ?>"><?php echo $employee->e_name; ?></option>
								<?php }?>
                            </select>
                        </div>
                    </div>
...
<div class="block full">
		...
		<div class="block-title">
			...
			<a href="<?php echo base_url()?>admin/booking_text_ro"><div class="btn btn-sm btn-primary" style="float: right; margin-right: 10px; margin-top: 5px;">
    ...
    <div class="modal-dialog">    
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <input   type="text" name="name_dop" id="name_dop" class="form-control input-datepicker-close" onchange="add_date1();" data-date-format="yyyy-mm-dd" placeholder="mm/dd/yyyy">
...

        {
          ...
          //  var size= $("#w_count1").val();
            ...
            $.ajax({
                ...
                url: "<?php echo base_url(); ?>" + "admin/booking_text_ro/get_price",
...
//          date_pic();
...

        {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url(); ?>" + "admin/booking_text_ro/get_fdays",
	...
	*/
          ...
          //  alert(dates);
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url(); ?>" + "admin/booking_text_ro/get_dop_price",
    ...
    <script type="text/javascript">
     ...
     function save_ro(){
            ...
            var form_data= {'client':client,'newspaper':newspaper,'state_id':state_id,'pub_id':pub_id,'title':title,'matter':matter,'cat':cat,'sheading':sheading,'pack':pack,'inse':inse,'scheme':scheme,'material':material,'party':party,'premimum':premimum,'box':box,'remark':remark,'price':price,'eprice':eprice,'w_count':w_count,'unit':unit,'p_date':p_date,'ro_type':ro_type,'t_amount':t_amount,'p_amount':p_amount,'dis':dis,'dis_a':dis_a,'comm1':comm1,'comm2':comm2,'comm3':comm3,'comm4':comm4,'comm5':comm5,'comm6':comm6,'comm7':comm7,'comm8':comm8,'box_c':box_c,'add_a':add_a,'igst':igst,'sgst':sgst,'cgst':cgst,'odf':odf,'dop_inse':inse_dop,'free_days':free_days,'book_id':book_id};



            $.ajax({                

                url: "<?php echo base_url(); ?>" + "admin/booking_text_ro/save",
	...
	alert("Ro added Successfully");					
					...
					$.each(tr, function(i, d) 
					{
						...
						$("#ecom-products tbody").append('<tr><td class="text-center"><strong>'+d.id+'</strong></td><td>'+d.newspaper_name+'</td><td class="text-center">'+d.type_name+'</td><td class="text-center">'+d.cat_name+'</td><td class="text-center">'+d.ad_cost+'</td><td class="text-center">'+d.insertion+'</td><td class="text-center">'+d.client_name+'<br>'+d.email+'<br>'+d.mobile+'</td><td class="text-center"><div class="btn-group btn-group-xs"><a class="btn btn-default" target="_blank" title="" data-toggle="tooltip" href="http://s650006054.onlinehome.us/amson/admin/book_ads/edit/'+d.id+'" data-original-title="Edit"><i class="fa fa-pencil"></i></a></div></td></tr>');
					...
					document.getElementById('sheading').selectedIndex = 0;
...

        {
            ...
            $.ajax({                
                ...
                url: "<?php echo base_url(); ?>" + "admin/booking_text_ro/get_city",
...

        {
            ...
            $.ajax({                
                ...
                url: "<?php echo base_url(); ?>" + "admin/booking_text_ro/get_heading",
...

        {
            ...
            $.ajax({                
                ...
                url: "<?php echo base_url(); ?>" + "admin/booking_text_ro/get_sub_heading",
...

        {
            ...
            $.ajax({                
                ...
                url: "<?php echo base_url(); ?>" + "admin/booking_text_ro/get_scheme",
...

        {
            ...
            $.ajax({                
                ...
                url: "<?php echo base_url(); ?>" + "admin/booking_text_ro/get_scheme_price",
        ...
        function get_agencies()
            ...
            $.ajax({                
                ...
                url: "<?php echo base_url(); ?>" + "admin/booking_text_ro/get_agency",
...

        {
            ...
            $.ajax({                
                ...
                url: "<?php echo base_url(); ?>" + "admin/booking_text_ro/get_premimum",
...

        {
            ...
            $.each(pre_id, function(i, id) {
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url(); ?>" + "admin/booking_text_ro/get_premimum_price",
	...
	$.ajax({                
        ...
        function get_pack_price(){		
            ...
            $.ajax({
                ...
                url: "<?php echo base_url(); ?>" + "admin/booking_text_ro/get_package_price",
      ...
      function add_paper()
        ...
        function get_paper(){
            ...
            $.ajax({                
                ...
                url: "<?php echo base_url(); ?>" + "admin/booking_text_ro/get_newspaper",
...
$.each(ar1, function(i, d) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url(); ?>" + "admin/booking_text_ro/get_ad_on_price",
...

                {
                 ...
                 // var p_u= document.getElementById('add_pub_dates');
                    ...
                    //var html='<div class="alert alert-info" ><i class="fa fa-money"></i><strong> DOP and Price of  '+ data['values'].data +'</strong></div>                   <div class="form-group">                     <label for="pack-price" class="col-md-6 alert alert-info" onclick="date_pic_byid('+data['values'].a_newspaper_id +');" style="cursor:crosshair">Publish Dates of '+ data['values'].data +'</label>                    <div class="col-md-6">	                    <div class="box"  id="from--input">	                    <input class="form-control" name="p_date'+ data['values'].a_newspaper_id +'" type="text" id="from-input'+ data['values'].a_newspaper_id +'" placeholder="mm/dd/yyyy, ..." >	                    </div>	                    <div class="code-box">	                    </div>                    </div>                    </div>                          <div class="form-group">                    <label for="pack-price" class="col-md-3 control-label">Rate</label>                    <div class="col-md-3">                    <input type="text" placeholder="" onchange="amount_calculate();" class="form-control" name="rate'+ data['values'].a_newspaper_id +'" id="rate'+ data['values'].a_newspaper_id +'" value="'+ data['rates'].price +'">                   </div>                    <label for="pack-price" class="col-md-3 control-label">Extra Charges</label>                    <div class="col-md-3">                    <input type="text" placeholder="" onchange="amount_calculate();" class="form-control" name="erate'+ data['values'].a_newspaper_id +'" id="erate'+ data['values'].a_newspaper_id +'"  value="'+ data['rates'].e_price +'">                    </div>                    </div>                    <div class="form-group"><label for="pack-price" class="col-md-3 control-label">B Rate</label>                    <div class="col-md-3">                    <input type="text" placeholder="" onchange="amount_calculate();" class="form-control" name="brate'+ data['values'].a_newspaper_id +'" id="brate'+ data['values'].a_newspaper_id +'" value="0">                    </div>                    <label for="pack-price" class="col-md-3 control-label">B Extra Charges</label>                    <div class="col-md-3">                    <input type="text" placeholder="" onchange="amount_calculate();" class="form-control" name="berate'+ data['values'].a_newspaper_id +'" id="berate'+ data['values'].a_newspaper_id +'"  value="0">                    </div>                    </div>';
                      var html='<div class="alert alert-info" ><i class="fa fa-money"></i><strong> DOP and Price of  '+ data['values'].data +'</strong></div>                   <div class="form-group">                     <label for="pack-price" class="col-md-6 alert alert-info" onclick="date_pic_byid('+data['values'].a_newspaper_id +');" style="cursor:crosshair">Publish Dates of '+ data['values'].data +'</label>                    <div class="col-md-6">	                    <div class="box"  id="from--input">	                    <input class="form-control mydata" name="p_date'+ data['values'].a_newspaper_id +'" type="text" id="from-input'+ data['values'].a_newspaper_id +'" data-id="'+ data['values'].a_newspaper_id +'" data-toggle="modal" data-target="#dopModal" onclick="showModal('+data['values'].a_newspaper_id+')" placeholder="mm/dd/yyyy, ..." >	                    </div>	               <div class="code-box">	                    </div>                    </div>                    </div>                          <div class="form-group">                    <label for="pack-price" class="col-md-3 control-label">Rate</label>                    <div class="col-md-3">                    <input type="text" placeholder="" onchange="amount_calculate();" class="form-control" name="rate'+ data['values'].a_newspaper_id +'" id="rate'+ data['values'].a_newspaper_id +'" value="'+ data['rates'].price +'">                   </div>                    <label for="pack-price" class="col-md-3 control-label">Extra Charges</label>                    <div class="col-md-3">                    <input type="text" placeholder="" onchange="amount_calculate();" class="form-control" name="erate'+ data['values'].a_newspaper_id +'" id="erate'+ data['values'].a_newspaper_id +'"  value="'+ data['rates'].e_price +'">                    </div>                    </div>                    <div class="form-group"><label for="pack-price" class="col-md-3 control-label">B Rate</label>                    <div class="col-md-3">                    <input type="text" placeholder="" onchange="amount_calculate();" class="form-control" name="brate'+ data['values'].a_newspaper_id +'" id="brate'+ data['values'].a_newspaper_id +'" value="0">                    </div>                    <label for="pack-price" class="col-md-3 control-label">B Extra Charges</label>                    <div class="col-md-3">                    <input type="text" placeholder="" onchange="amount_calculate();" class="form-control" name="berate'+ data['values'].a_newspaper_id +'" id="berate'+ data['values'].a_newspaper_id +'"  value="0">                    </div>                    </div>';
                    p_u.insertAdjacentHTML('beforeend', html);
               //date_pic_byid1(d);
        ...
        function get_base_price(){
            ...
            $.ajax({
                ...
                url: "<?php echo base_url(); ?>" + "admin/booking_text_ro/get_base_price",
...
alert(data['rates'].gst);
         ...
         //var html='<div class="alert alert-info" "><i class="fa fa-money"></i><strong> DOP and Price of  '+ data['rates'].newspaper_name +' ,'+ data['rates'].city_name +'</strong></div>                         <div class="form-group">	<label for="pack-price" class="col-md-6 alert alert-info" onclick="date_pic_byid('+data['value']+');" style="cursor:crosshair">Publish Dates of '+ data['rates'].newspaper_name +' ,'+ data['rates'].city_name +'</label> <div class="col-md-6">	<div class="box"  id="from--input">	<input class="form-control" name="p_date'+ data['value'] +'" type="text" id="from-input1'+ data['value'] +'" placeholder="mm/dd/yyyy, ..." >	</div>	<div class="code-box">	</div>	</div>	</div>                                                                       <div class="form-group"><label for="pack-price" class="col-md-3 control-label">Rate</label><div class="col-md-3"><input type="text" placeholder="" onchange="amount_calculate();" class="form-control" name="rate'+ data['value'] +'" id="rate'+ data['value'] +'" value="'+ data['rates'].ad_price +'"></div><label for="pack-price" class="col-md-3 control-label">Extra Rate</label><div class="col-md-3"><input type="text" placeholder="" onchange="amount_calculate();" class="form-control" name="erate'+ data['value'] +'" id="erate'+ data['value'] +'" value="'+ data['rates'].extra_price +'"></div></div>                                           <div class="form-group"><label for="pack-price" class="col-md-3 control-label">B Rate</label><div class="col-md-3"><input type="text" placeholder="" onchange="amount_calculate();" class="form-control" name="brate'+ data['value'] +'" id="brate'+ data['value'] +'" value="0"></div><label for="pack-price" class="col-md-3 control-label">B Extra Rate</label><div class="col-md-3"><input type="text" placeholder="" onchange="amount_calculate();" class="form-control" name="berate'+ data['value'] +'" id="berate'+ data['value'] +'" value="0"></div></div>';
          var html='<div class="alert alert-info" "><i class="fa fa-money"></i><strong> DOP and Price of  '+ data['rates'].newspaper_name +' ,'+ data['rates'].city_name +'</strong></div>                         <div class="form-group">	<label for="pack-price" class="col-md-6 alert alert-info" onclick="date_pic_byid('+data['value']+');" style="cursor:crosshair">Publish Dates of '+ data['rates'].newspaper_name +' ,'+ data['rates'].city_name +'</label> <div class="col-md-6">	<div class="box"  id="from--input">	<input class="form-control mydata" name="p_date'+data['value'] +'" type="text" id="from-input'+ data['value']+'" data-id="'+ data['value']+'" data-toggle="modal" data-target="#dopModal" onclick="showModal('+data['value']+')"  placeholder="mm/dd/yyyy, ..." >	</div>	<div class="code-box">	</div>	</div>	</div>                                                                       <div class="form-group"><label for="pack-price" class="col-md-3 control-label">Rate</label><div class="col-md-3"><input type="text" placeholder="" onchange="amount_calculate();" class="form-control" name="rate'+ data['value']+'" id="rate'+data['value'] +'" value="'+ data['rates'].ad_price +'"></div><label for="pack-price" class="col-md-3 control-label">Extra Rate</label><div class="col-md-3"><input type="text" placeholder="" onchange="amount_calculate();" class="form-control" name="erate'+ data['value'] +'" id="erate'+ data['value'] +'" value="'+ data['rates'].extra_price +'"></div></div>                                           <div class="form-group"><label for="pack-price" class="col-md-3 control-label">B Rate</label><div class="col-md-3"><input type="text" placeholder="" onchange="amount_calculate();" class="form-control" name="brate'+ data['value'] +'" id="brate'+ data['value']+'" value="0"></div><label for="pack-price" class="col-md-3 control-label">B Extra Rate</label><div class="col-md-3"><input type="text" placeholder="" onchange="amount_calculate();" class="form-control" name="berate'+ data['value'] +'" id="berate'+ data['value']+'" value="0"></div></div>';
