		...
		<div class="col-lg-12">
			...
			<div class="block">
				...
				<?php
					...
					echo form_open_multipart('admin/hd_package/edit/'.$pack->id, $attributes); ?>
					<?php
                        ...
                        <div class="col-md-9">
							<select id="ad_cat" name="ad_cat" class="select-chosen" data-placeholder="Choose Heading" required>
								<?php foreach($cats as $cat){ ?>
                                        <option value="<?php echo $cat->id; ?>" <?php if($pack->cat_id==$cat->id)echo "selected";?>><?php echo $cat->position; ?></option>
								<?php }?>								
                            </select>
                        </div>
                    </div>
