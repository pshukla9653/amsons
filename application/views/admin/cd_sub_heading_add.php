<div id="page-content" style="min-height: 1189px;">
	...
	<div class="row">
		<div class="block">
			...
			echo form_open_multipart('admin/cd_categories/sub_add', $attributes); ?>
			<?php
			...
			?>
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="text" placeholder="Sub Heading Name" required="required" class="form-control" name="heading" id="heading">
					</div>
				</div>
