<div id="page-content" style="min-height: 1189px;">
	...
	<?php 
					...
					echo form_open_multipart('admin/hd_ro/add', $attributes); ?>
					<?php
			...
			<div class="block">
				...
				<div class="block-title">
					<h2>
						...
						<strong>New HD Display Ro Booking</strong>
					</h2>
				</div>
				...
				<!-- General Data Content -->
					...
					<div id="add_on_paper" style="display: none;">
						<div class="form-group">
							...
							<div class="col-md-9">
							     <input type="hidden" id="size_type">
		...
		<div class="col-lg-6">
			...
			<div class="block">
				...
				<!-- General Data Content -->
					...
					<div class="form-group">
						<label for="pack-price" class="col-md-3 control-label">Remarks</label>
						<div class="col-md-9">
							<input type="text" placeholder="" class="form-control" name="remark" id="remark" >
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-2">
							<input type="text" placeholder="" onchange="get_size();" class="form-control" name="size_l" id="size_l" value="0" required>
						</div>
						<div class="col-md-1 control-label">
							X
						</div>
						<div class="col-md-2">
							<input type="text" placeholder="" onchange="get_size();" class="form-control" name="size_r" id="size_r" value="0" required>
						</div>
						<div class="col-md-4">
...
<div class="block full">
		...
		<div class="block-title">
			...
			<a href="<?php echo base_url()?>admin/hd_ro"><div class="btn btn-sm btn-primary" style="float: right; margin-right: 10px; margin-top: 5px;">
...
function add_date(id=null)
     ...
     function get_price()
    {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>" + "admin/booking_hd_ro/get_price",
            type: "POST",				
            async: true ,               
            data: form_data,
			...
			success: function(data)
				{
					...
					if(data=='1')
					{
						alert("Select Newspaper,Position and enter Insertion First.");
						/*$('#inse').val(function() 
						{
							return this.defaultValue;
						});*/
...
//alert(id);
  ...
  function get_dop_price()
    {
        ...
        {
            //alert(s_days[i]);
            var form_data= {'newspaper':newspaper,'cat':cat,'inse':inse,'s_date':s_days[i],'count':i,'color':color};
            //alert(s_days[i]);
            //console.log(JSON.stringify(form_data)); return false;
            $.ajax({
                url: "<?php echo base_url(); ?>" + "admin/booking_hd_ro/get_dop_price",
                type: "POST",				
                async: true ,               
                data: form_data,
                beforeSend: function(){ document.getElementById("loader").style.display = "block";},
                success: function(data)
                {
                    ...
                    //console.log("data"+data['rates'].ad_price);
 ...
 datarate=data;
                    if(data['rates'].size_type=="F"){
                        ...
                        document.getElementById("rate"+data['values'].count).value = data['rates'].f_rate;
                        document.getElementById("brate"+data['values'].count).value = data['rates'].b_rate;					
                        document.getElementById("size_type").value="F";

                    }else{

                        document.getElementById("rate"+data['values'].count).value = data['rates'].ad_price;					
                        document.getElementById("brate"+data['values'].count).value = data['rates'].b_rate;
                        document.getElementById("size_type").value="S";
                    }
...
function save_ro()
{
	...
	var form_data= {'client':client,'employee':employee,'newspaper':newspaper,'title':title,'matter':matter,'cat':cat,'sheading':sheading,'pack':pack,'inse':inse,'scheme':scheme,'material':material,'party':party,'premimum':premimum,'box':box,'remark':remark,'price':price,'eprice':eprice,'w_count':w_count,'size_type':size_type,'p_date':p_date,'ro_type':ro_type,'t_amount':t_amount,'p_amount':p_amount,'dis_a':dis_a,'color':color,'comm1':comm1,'comm2':comm2,'comm3':comm3,'comm4':comm4,'comm5':comm5,'comm6':comm6,'comm7':comm7,'comm8':comm8,'box_c':box_c,'add_a':add_a,'odf':odf,'book_id':book_id};
