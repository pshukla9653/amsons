        ...
        $.ajax({                
            ...
            success: function(data)
            {
                ...
                $.each(tr.client_data, function(i, d) 
                       {
                    $("#ecom-products tbody").append('<tr  style="cursor:pointer" id="row_'+d.id+'"><td class="text-center"><strong><input type="checkbox" class="tb_bill_id" name="tb_bill_id" value="'+d.id+'"/></strong></td><td class="text-center"><strong>'+d.bill_no+'</strong></td><td>'+d.bill_date+'</td><td class="text-center">'+d.total+'</td><td class="text-center">'+d.dis_per+'</td><td class="text-center">'+d.total+'</td><td class="text-center">'+d.net_amount+'</td><td class="text-center">'+d.Shared_Status+'</td></tr>');
                });
               },                
            error: function() 
            {
