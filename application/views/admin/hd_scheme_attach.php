		...
		<div class="col-lg-12">
			...
			<div class="block">
				...
				<?php 
					...
					echo form_open('admin/hd_scheme_attach/add', $attributes)
					?>
					<?php
					...
					<div class="form-group">
						...
						<div class="col-md-2">
							<input type="number" step="any" min="0" placeholder="" class="form-control" name="dis" id="dis" value="<?php echo set_value('dis'); ?>">
						</div>
						<div class="col-md-1">
