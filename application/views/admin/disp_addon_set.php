		...
		<div class="col-lg-12">
			...
			<div class="block">
				...
				<?php 
					...
					echo form_open_multipart('admin/disp_price_addon/revise/'.$add_on->id, $attributes); ?>
					<?php
					...
					<div class="form-group">
                        ...
                        <div class="col-md-9">
							<select id="unit" name="unit" class="form-control" data-placeholder="" required>
								<option value="">Choose one</option>
								<option value="SC" <?php echo ('SC'==$add_on->unit)?'selected':'';?>>SQCM</option>
								<option value="CC" <?php echo ('CC'==$add_on->unit)?'selected':'';?>>PCC</option>
                            </select>
                        </div>
                    </div>
                    	<div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="date_from" name="date_from" class="form-control input-datepicker-close" data-date-format="mm/dd/yyyy" placeholder="mm/dd/yyyy" value=" " required>
                        </div>
                        	<div class="form-group">
					<!--	<label for="price" class="col-md-3 control-label">Date to</label>
                        <div class="col-md-9">
                            <input type="text" id="date_to" name="date_to" class="form-control input-datepicker-close" data-date-format="mm/dd/yyyy" placeholder="mm/dd/yyyy" value="" required>
                        </div>-->
                    </div>
                    </div>
