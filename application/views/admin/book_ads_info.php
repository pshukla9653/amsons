<div id="page-content" style="min-height: 1189px;">
	...
	<div class="block full">
		...
		<div class="block-title">
			...
			<h2>
				<strong>Ad</strong> Full Details<br>
			...
			<div class="row">
				...
				<table class="table table-bordered table-striped table-vcenter dataTable no-footer" id="ecom-products" role="grid" aria-describedby="ecom-products_info">
						...
						<tr>
							...
							<td style="width: 50%;" class="text-left">
								<strong><?php echo $book_ad->book_date; ?></strong>
							</td>
						</tr>						
						<tr>
						...
						<tr>
							<td style="width: 50%;" class="text-left">Cost</td>
							<td style="width: 50%;" class="text-left">
						...
						*/ ?>
						...
						<tr>
							...
							<td style="width: 50%;" class="text-left">
								<a class="" title="" data-toggle="tooltip" href="<?php echo base_url(); ?>admin/book_ads/ro/<?php echo $book_ad->id;
