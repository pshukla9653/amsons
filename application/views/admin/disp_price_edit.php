		...
		<div class="col-lg-12">
			...
			<div class="block">
				...
				<?php 
					...
					echo form_open('admin/disp_price/edit/'.$ad_price->id, $attributes)
					?>
					<?php
				...
				<div class="col-lg-6">
					...
					<!--<div class="form-group">
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="" class="form-control" name="fprice" id="fprice" value="<?php echo $ad_price->f_rate; ?>">
                        </div>
                    </div>
					<div class="form-group">
