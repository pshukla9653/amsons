		...
		<div class="col-lg-12">
			...
			<div class="block">
				...
				<?php 
					...
					echo form_open('admin/hd_price/edit/'.$ad_price->id, $attributes)
					?>
					<?php
				...
				<div class="col-lg-6">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" placeholder="" class="form-control" value="<?php echo $ad_price->f_size?>" name="size" id="size">
						</div>						
					</div>
					<div class="form-group">
...
$(document).ready(function (){ get_heading();   fix_s();});
