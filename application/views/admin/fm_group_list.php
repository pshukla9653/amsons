<div id="page-content" style="min-height: 1189px;">
	...
	<div class="row text-center">
		<div class="col-sm-6 col-lg-3">
			<a class="widget widget-hover-effect2" href="<?php echo base_url();?>admin/fm/group_add">
				<div class="widget-extra themed-background-success">
					<h4 class="widget-content-light">
						<strong>Add FM</strong> Group
					</h4>
				</div>
			...
			<div class="row">
				<div class="col-sm-6 col-xs-7">
					...
					<?php 
						...
						echo form_open('admin/fm/', $attributes);
					?>
...
-->							
                            <td class="text-center">
								<div class="btn-group btn-group-xs">
									<a class="btn btn-default" title="" data-toggle="tooltip" href="<?php echo base_url(); ?>admin/fm/group_edit/<?php echo $newspaper_group->ng_id ; ?>" data-original-title="Edit">
										<i class="fa fa-pencil"></i>
									</a>
									<a class="btn btn-xs btn-danger" title="" data-toggle="tooltip" onclick="return confirm('Are you sure you want to delete this Newspaper Group?');" href="<?php echo base_url(); ?>admin/fm/group_del/<?php echo $newspaper_group->ng_id ;?>" data-original-title="Delete">
