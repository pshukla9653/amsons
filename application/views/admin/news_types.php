<div id="page-content" style="min-height: 1189px;">
	...
	<div class="row text-center">
		<div class="col-sm-6 col-lg-3">
			<a class="widget widget-hover-effect2" href="<?php echo base_url();?>admin/news_type/add">
				<div class="widget-extra themed-background-success">
					<h4 class="widget-content-light">
						<strong>Add News</strong> Type					
					</h4>
				</div>
					...
					<tbody>
						...
						<tr role="row" class="odd">
							<td class="text-center">
									<strong><?php echo $type->id ;?></strong>
							</td>
							<td>
								<?php echo $type->name ;?>
							</td>
							...
							<td class="text-center">
								<div class="btn-group btn-group-xs">
									<a class="btn btn-default" title="" data-toggle="tooltip" href="<?php echo base_url(); ?>admin/news_type/edit/<?php echo $type->id ;?>" data-original-title="Edit">
										<i class="fa fa-pencil"></i>
									</a>
									<a class="btn btn-xs btn-danger" title="" data-toggle="tooltip" href="<?php echo base_url(); ?>admin/news_type/del/<?php echo $type->id ;?>" data-original-title="Delete">
