<div id="page-content" style="min-height: 1189px;">
        ...
        <div class="col-lg-12">
            ...
            <div class="block">
                ...
                <?php
                        ...
                        echo form_open('admin/disp_price/add', $attributes)
                ?>
                <?php
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <select id="newspaper" name="newspaper" class="form-control"  onchange="get_heading();" data-placeholder="Choose Newspaper" required>
    ...
    <div class="col-md-9">
                    ...
                    <div  id="double_c" style="display: none;">
                        <div id="double_c" class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" placeholder="" class="form-control" name="d_min_l" id="d_min_l" >
                            </div>
                            <div class="col-md-1 control-label">
                                X
                            </div>
                            <div class="col-md-3">
                                <input type="text" placeholder="" class="form-control" name="d_min_r" id="d_min_r" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="price" class="col-md-3 control-label"></label>
                            ...
                            <div class="col-md-3">
                                <input type="text" placeholder="" class="form-control" name="d_max_l" id="d_max_l" >
                            </div>
                            <div class="col-md-1 control-label">
                                X
                            </div>
                            <div class="col-md-3">
                                <input type="text" placeholder="" class="form-control" name="d_max_r" id="d_max_r" >
                            </div>
                        </div>
                    </div>					
                    <div class="form-group">
                    ...
                    <!--<div class="form-group">
                            ...
                            <div class="col-md-9">
                                    <input type="text" placeholder="" class="form-control" name="bprice" id="bprice" required>
                            </div>
                    </div>-->
                    <div class="form-group">
                            <label for="price" class="col-md-3 control-label">Fix Price</label>
                            <div class="col-md-9">
                                    <input type="text" placeholder="" class="form-control" name="fprice" id="fprice" required>
                            </div>
                    </div>
                   <!-- <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        function get_heading()
        {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>" + "admin/disp_price/get_heading",
                type: "POST",
                async: true,
                data: {id: newspaper},
                beforeSend: function () {
