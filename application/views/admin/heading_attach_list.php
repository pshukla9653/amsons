<div id="page-content" style="min-height: 1189px;">
	...
	<div class="row text-center">
		<div class="col-sm-6 col-lg-3">
			<a class="widget widget-hover-effect2" href="<?php echo base_url();?>admin/heading/add">
			...
			<div class="row">
				<div class="col-sm-6 col-xs-7">
					...
					<?php 
						...
						echo form_open('admin/heading/', $attributes);
					?>
						...
						<tr role="row" class="odd">
							...
							<td class="text-center">
								<div class="btn-group btn-group-xs">
									<a class="btn btn-xs btn-danger" title="" data-toggle="tooltip"  onclick="return confirm('Are you sure you want to delete this heading?');" href="<?php echo base_url(); ?>admin/heading/del/<?php echo $paper->id ;?>" data-original-title="Delete">
