		...
		<div class="col-lg-12">
			...
			<div class="block">
				...
				<?php 
					...
					echo form_open_multipart('admin/sub_admin/add', $attributes); ?>
					<?php
					...
					?>
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" placeholder="Enter Name" required="required" class="form-control" name="name" id="name">
							</div>
							</div>
							<div class="form-group">
							<label for="name" class="col-md-3 control-label">E-mail</label>
								<div class="col-md-9">
									<input type="email" placeholder="Enter E-mail" required="required" class="form-control" name="email" id="email">
								</div>
							</div>
							<div class="form-group">
							...
							<label for="name" class="col-md-3 control-label">Mobile</label>
								<div class="col-md-9">
									<input type="text" placeholder="Enter Mobile" required="required" class="form-control" name="mobile" id="mobile">
								</div>
							</div>
							<div class="form-group">
